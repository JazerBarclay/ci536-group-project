...
public class API {
  ...
  public static HttpResponse postRequest(String endpoint, Map<String, String> json)
      throws MalformedURLException, IOException {
    return postRequest(null, endpoint, json);
  }

  public static HttpResponse postRequest(String token, String endpoint, Map<String, String> json)
      throws MalformedURLException, IOException {
    URL url;
    HttpResponse res;
