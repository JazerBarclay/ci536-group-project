...
/**
 * A simple screen template which utilises the MVC design
 * pattern.
 * 
 * @author Jazer
 *
...
public abstract class Screen {
    ...
    /**
     * Template method to construct the MVC design pattern
     * associated with this implementation of a screen.
     * 
     * @param window
     */
