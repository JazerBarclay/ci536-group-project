...
/**
 * An abstract template for an MVC screen model. Includes simple function for
 * adding a screen event listener and storing in protected class variable.
 * 
 * @author Jazer
 *
 */
public abstract class ScreenModel {
  ...
  /**
   * Sets a listener within the model which can update the view on event changes.
   * 
   * @param listener
   */
