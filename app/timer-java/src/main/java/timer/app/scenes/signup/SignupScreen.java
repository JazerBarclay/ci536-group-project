...
/**
 * The signup screen where users can enter their email, desired username
 * and password in order to create a new account. Once complete, they can
 * be forwarded to the login screen to attempt a login with their newly
 * set account details.
 * 
 * @author Jazer
 *
